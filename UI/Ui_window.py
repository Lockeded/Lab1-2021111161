...
"background-color:transparent")
        ...
        self.InfoBadge.setGeometry(QtCore.QRect(120, 10, 171, 31))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(15)
        font.setBold(False)
        ...
        self.graphImage.setGeometry(QtCore.QRect(20, 40, 381, 421))
        ...
        self.LineEdit_3.setGeometry(QtCore.QRect(40, 50, 301, 33))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.PushButton_3.setGeometry(QtCore.QRect(350, 50, 61, 32))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.SimpleCardWidget_2.setGeometry(QtCore.QRect(40, 90, 331, 61))
        ...
        self.PrimaryPushButton_2.setGeometry(QtCore.QRect(180, 80, 61, 32))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.LineEdit_4.setGeometry(QtCore.QRect(40, 60, 128, 33))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        ...
        self.LineEdit_5.setGeometry(QtCore.QRect(40, 100, 128, 33))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.CardWidget_6.setGeometry(QtCore.QRect(10, 140, 231, 171))
        self.CardWidget_6.setObjectName("CardWidget_6")
        self.CaptionLabel_4 = CaptionLabel(self.CardWidget_6)
        self.CaptionLabel_4.setGeometry(QtCore.QRect(0, 0, 231, 171))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.PrimaryPushButton_3 = PillPushButton(self.CardWidget_2)
        self.PrimaryPushButton_3.setGeometry(QtCore.QRect(60, 40, 141, 32))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.CardWidget_7.setGeometry(QtCore.QRect(30, 70, 201, 241))
        self.CardWidget_7.setObjectName("CardWidget_7")
        self.CaptionLabel_3 = CaptionLabel(self.CardWidget_7)
        self.CaptionLabel_3.setGeometry(QtCore.QRect(0, 10, 201, 221))
        font = QtGui.QFont()
        font.setFamily("YouYuan")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.PrimaryPushButton_3.clicked.connect(self.randomWalk) # type: ignore # type: ignore
...
from qfluentwidgets import CaptionLabel, CardWidget, ElevatedCardWidget, IconWidget, InfoBadge, LineEdit, PrimaryPushButton, PushButton, SimpleCardWidget,PillPushButton
from . import ui_rc
